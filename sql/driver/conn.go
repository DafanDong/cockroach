...
func (c *conn) Exec(query string, args []driver.Value) (driver.Result, error) {
	...
	return c.exec(createCall(query, args), stmt, args)
}
...
func (c *conn) Query(query string, args []driver.Value) (driver.Rows, error) {
	...
	return c.query(createCall(query, args), stmt, args)
}
...
func (c *conn) exec(call sqlwire.Call, stmt parser.Statement, args []driver.Value) (driver.Result, error) {
	rows, err := c.query(call, stmt, args)
	if err != nil {
		return nil, err
	}
...
func (c *conn) query(call sqlwire.Call, stmt parser.Statement, args []driver.Value) (*rows, error) {
...
func (c *conn) processInsertRows(node parser.InsertRows) (*rows, error) {
	...
	case parser.Values:
		...
		return r, nil
	case *parser.Select:
		return c.query(sqlwire.Call{}, nt, nil)
	case *parser.Union:
		return c.query(sqlwire.Call{}, nt, nil)
	}
